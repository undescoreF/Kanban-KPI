...
## Функционал
* Отображение задач по колонкам (Kanban)
* Перетаскивание задач между колонками и изменение порядка внутри них
* Оптимистичное обновление интерфейса с автоматическим откатом при ошибке сервера
* Поиск задач в реальном времени
* Скрытие пустых колонок во время поиска
